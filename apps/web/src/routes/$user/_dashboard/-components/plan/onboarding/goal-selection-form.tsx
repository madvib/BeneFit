...
export function GoalSelectionForm({
  onGenerate,
  isLoading = false,
}: Readonly<GoalSelectionFormProps>) {
        ...
        footer={
          <div className="flex items-center justify-between gap-4">
            ...
            <Button
              ...
              isLoading={isLoading}
              type="button"
              className={`${typography.p} shadow-primary/20 min-w-[160px] rounded-xl px-8 shadow-lg`}
            >
                  ...
                  return (
                    <div className="space-y-4">
                      ...
                      <div className="bg-accent/10 flex flex-col items-center gap-4 rounded-3xl border p-5 sm:flex-row sm:gap-6 sm:p-8">
                        ...
                        <IconBox
                          variant="ghost"
                          className={`${typography.displayMdInherit} bg-primary text-primary-foreground h-14 w-14 shrink-0 rounded-2xl shadow-lg`}
                        >
                          {workoutsPerWeek}
                        </IconBox>
                      </div>
