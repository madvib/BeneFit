    ...
    <Card className="from-primary/10 via-background to-background border-primary/20 relative overflow-hidden bg-linear-to-br shadow-2xl">
      ...
      <div className="relative p-6 sm:p-8">
        ...
        <Button
          ...
          className="text-muted-foreground hover:text-primary rounded-full transition-all absolute top-2 right-2 z-10"
        >
          <Edit2 size={18} />
        </Button>
        ...
        <div className="grid grid-cols-1 gap-6 lg:grid-cols-2">
          ...
          <div className="flex flex-col">
            <div className="mb-6">
              <div className={`${typography.mutedXs} mb-2 flex flex-wrap gap-2 opacity-80`}>
                <Badge variant="success" className="px-2 py-0.5">
                  Week{' '}
                  {typeof currentPlan.currentWeek === 'object'
                    ? (currentPlan.currentWeek as any).weekNumber
            ...
            <div className="bg-primary/5 border-primary/10 relative mt-auto overflow-hidden rounded-2xl border p-6">
          ...
          <div className="flex flex-col justify-between space-y-6">
            ...
            <div className="from-primary/10 border-primary/20 mt-auto rounded-2xl border bg-linear-to-br to-transparent p-4">
