...
export const typography = {
  ...
  displayLgResponsive: 'text-2xl sm:text-3xl font-black tracking-tighter italic text-foreground transition-colors',
  ...
  labelSm: 'text-sm font-black tracking-widest uppercase text-foreground transition-colors',
} as const;
