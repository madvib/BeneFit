...
import { Card, CountUp } from '@/lib/components';
        ...
        <div className="p-4 sm:p-5">
          ...
          <div className="space-y-3">
            ...
            <div className="border-muted flex flex-col justify-between border-b pb-2 sm:flex-row">
              ...
              <span className="font-semibold">
                <CountUp to={stats.totalMinutes || 0} /> min
              </span>
            </div>
            <div className="border-muted flex flex-col justify-between border-b pb-2 sm:flex-row">
              <span className="text-muted-foreground">Total Volume:</span>
              <span className="font-semibold">
                <CountUp to={stats.totalVolume || 0} separator="," /> lbs
              </span>
            </div>
            <div className="border-muted flex flex-col justify-between border-b pb-2 sm:flex-row">
              <span className="text-muted-foreground">Last Workout:</span>
              <span className="font-semibold">{safeFormatDate(stats.lastWorkoutDate)}</span>
            </div>
