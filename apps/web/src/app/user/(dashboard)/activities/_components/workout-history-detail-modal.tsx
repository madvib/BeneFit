        ...
        <div className="flex items-center gap-4">
          ...
          <div className="flex flex-col">
            <div className="flex items-center gap-2">
              <h1 className={`${typography.h3} text-foreground md:text-3xl`}>
                {workout.workoutType}
              </h1>
            ...
            <span className={`${typography.small} text-muted-foreground`}>{date}</span>
          </div>
        </div>
          ...
          <div className="grid grid-cols-2 gap-4 lg:grid-cols-4">
            <Card bodyClassName="p-4 flex flex-col gap-1" className="border-border bg-card">
              <div className="text-muted-foreground flex items-center gap-2">
                <Clock size={16} />
                <span className={typography.mutedXs}>Duration</span>
              </div>
              <div className={`${typography.h2} text-foreground`}>
                {workout.performance.durationMinutes}{' '}
                <span className={`${typography.muted} font-normal`}>min</span>
              </div>
            </Card>
            <Card bodyClassName="p-4 flex flex-col gap-1" className="border-border bg-card">
              <div className="text-muted-foreground flex items-center gap-2">
                <Flame size={16} />
                <span className={typography.mutedXs}>Calories</span>
              </div>
              <div className={`${typography.h2} text-foreground`}>
                {workout.performance.caloriesBurned ?? '--'}{' '}
                <span className={`${typography.muted} font-normal`}>kcal</span>
              </div>
            </Card>
            <Card bodyClassName="p-4 flex flex-col gap-1" className="border-border bg-card">
              <div className="text-muted-foreground flex items-center gap-2">
                <Activity size={16} />
                <span className={typography.mutedXs}>Energy</span>
              </div>
              <div className={`${typography.h2} text-foreground capitalize`}>
            ...
            <Card bodyClassName="p-4 flex flex-col gap-1" className="border-border bg-card">
              <div className="text-muted-foreground flex items-center gap-2">
                <Trophy size={16} />
                <span className={typography.mutedXs}>RPE</span>
              </div>
              <div className={`${typography.h2} text-foreground`}>
                {workout.performance.difficultyRating?.replace('_', ' ') ?? '-'}{' '}
                <span className={`${typography.muted} font-normal`}>/10</span>
              </div>
            </Card>
          </div>
