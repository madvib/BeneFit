...
import ActivityFeed from "@/presentation/activity-feed";
import ProgressBar from "@/presentation/common/progress-bar";
import {
  Card,
  DashboardLayout,
  PageContainer,
...
import { Goal, ChartData } from "@/infrastructure/data/types/data-types";
