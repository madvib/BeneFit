...
CREATE TABLE `coaching_conversation` (
	...
	`total_user_messages` integer DEFAULT 0 NOT NULL,
	`total_coach_messages` integer DEFAULT 0 NOT NULL,
	`total_check_ins` integer DEFAULT 0 NOT NULL,
	`pending_check_ins` integer DEFAULT 0 NOT NULL,
	`started_at` integer DEFAULT (unixepoch() * 1000) NOT NULL,
	`last_message_at` integer DEFAULT (unixepoch() * 1000) NOT NULL,
	`last_context_update_at` integer NOT NULL
);
--> statement-breakpoint
...
CREATE TABLE `active_workout_plan` (
	...
	`end_date` integer,
	`weeks_json` text DEFAULT ('[]') NOT NULL,
	`started_at` integer,
...
CREATE TABLE `profile` (
	...
	`fitness_goals_target_date` integer,
	`fitness_goals_json` text NOT NULL,
	`training_constraints_json` text NOT NULL,
	`last_assessment_date` integer NOT NULL,
	`experience_profile_json` text NOT NULL,
	`created_at` integer DEFAULT (unixepoch() * 1000) NOT NULL,
	`updated_at` integer DEFAULT (unixepoch() * 1000) NOT NULL,
...
CREATE TABLE `completed_workouts` (
	...
	`verification_json` text DEFAULT ('{"verified":false,"verifications":[],"sponsorEligible":false}') NOT NULL,
