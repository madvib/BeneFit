...
import { toDomain, toDatabase } from '../../src/mappers/completed-workout.mapper.js';
import { completedWorkouts } from '../../src/data/schema';
import { user_do_schema } from '../../src/data/schema/index.js';
import migrations from '../../migrations/migrations.js';

/**
 * Tests for CompletedWorkout Mapper using Cloudflare Durable Objects
 */
describe('CompletedWorkoutMapper (Durable Objects)', () => {
  ...
  describe('toDatabase', () => {
    it('should map domain CompletedWorkout to database schema', async () => {
      await runInDurableObject(stub, async (instance: any, state: any) => {
    ...
    it('should handle duration conversion (minutes to seconds)', async () => {
      await runInDurableObject(stub, async (instance: any, state: any) => {
        const workout = createCompletedWorkoutFixture({
          performance: {
