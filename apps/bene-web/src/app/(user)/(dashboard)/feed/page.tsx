      ...
      {currentGoal ? (
        <div>
          ...
          <div className="mb-4">
            <div className="flex flex-col sm:flex-row sm:justify-between sm:items-center gap-2 text-sm mb-1">
              <div className="flex gap-2">
                <span className="font-medium">{currentGoal.currentValue} {currentGoal.unit}</span>
                <span className="text-muted-foreground">/ {currentGoal.targetValue} {currentGoal.unit}</span>
              </div>
            </div>
            <ProgressBar 
          ...
          <div className="text-sm space-y-1">
            ...
            <p className="text-muted-foreground break-words">
              Remaining: {(currentGoal.targetValue - currentGoal.currentValue).toFixed(1)} {currentGoal.unit}
            </p>
          </div>
        </div>
      ) : (
