      ...
      <div className="bg-secondary p-4 sm:p-6 rounded-lg shadow-md max-w-4xl mx-auto">
        ...
        <div className="grid grid-cols-1 gap-6 mb-6">
          <div className="bg-background p-4 sm:p-5 rounded-lg">
            <h3 className="text-lg sm:text-xl font-semibold mb-3">Fitness Goals</h3>
          ...
          <div className="bg-background p-4 sm:p-5 rounded-lg">
            <h3 className="text-lg sm:text-xl font-semibold mb-3">Statistics</h3>
        ...
        <div className="flex justify-end">
          <button className="btn btn-primary px-6 py-2 text-base">Save Profile</button>
        </div>
      </div>
    </PageContainer>
  );
