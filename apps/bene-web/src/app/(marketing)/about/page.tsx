    ...
    <div className="container mx-auto p-8">
      <div className="text-center mb-12">
        ...
        <p className="text-xl text-muted-foreground max-w-3xl mx-auto">
          Our mission is to help you achieve your fitness goals through powerful
          tracking, analytics, and community support.
        </p>
      </div>
            ...
            <div className="aspect-w-16 aspect-h-9 bg-background rounded-lg flex items-center justify-center">
              <div className="text-center p-8">
                ...
                <p className="text-muted-foreground">
                  ...
                  fitness journey through data-driven insights and community
                  support.
                </p>
              </div>
            </div>
      ...
      <div className="bg-secondary p-8 rounded-xl shadow-md mb-16">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div className="text-center">
            ...
            <p className="text-muted-foreground">
              Over 100,000 active users track their fitness goals with our
              platform every day.
            </p>
          </div>
          ...
          <div className="text-center">
            ...
            <p className="text-muted-foreground">
              Track workouts, nutrition, sleep, and more in one integrated
              platform.
            </p>
          </div>
          ...
          <div className="text-center">
            ...
            <p className="text-muted-foreground">
              Connect with friends and join challenges to stay motivated on your
              journey.
            </p>
          </div>
        </div>
