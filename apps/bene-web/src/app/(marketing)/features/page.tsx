    ...
    <div className="container mx-auto p-8">
      <div className="text-center mb-12">
        ...
        <p className="text-xl text-muted-foreground max-w-3xl mx-auto">
          BeneFit provides everything you need to track, analyze, and improve
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 mb-16">
        <div className="bg-secondary p-8 rounded-xl shadow-md">
          ...
          <p className="text-muted-foreground mb-4">
            Log and track all your workouts with detailed metrics, sets, reps,
            and weights. Create custom workout routines and follow structured
            programs.
          </p>
        ...
        <div className="bg-secondary p-8 rounded-xl shadow-md">
          ...
          <p className="text-muted-foreground mb-4">
            Visualize your progress with detailed analytics, charts, and
            insights. Set goals and track your achievements over time.
          </p>
          <ul className="space-y-2">
            <li className="flex items-center">
              <svg
      ...
      <div className="bg-secondary p-8 rounded-xl shadow-md mb-16">
        ...
        <p className="text-muted-foreground text-center max-w-2xl mx-auto mb-8">
          Seamlessly integrate with popular fitness and health platforms to get
          a complete picture of your wellness journey.
        </p>
