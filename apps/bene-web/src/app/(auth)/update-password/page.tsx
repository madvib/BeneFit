...
export default function UpdatePasswordPage() {
  ...
  const token = searchParams.get('token') || searchParams.get('access_token'); // access_token is what Supabase sends in the URL
    ...
    return (
      <div className="container mx-auto p-8 flex items-center justify-center min-h-screen">
        <div className="bg-secondary p-8 rounded-lg shadow-md w-full max-w-md">
          <h2 className="text-3xl font-bold mb-6 text-center text-secondary-foreground">Password Updated</h2>
  ...
  return (
    <div className="container mx-auto p-8 flex items-center justify-center min-h-screen">
      <div className="bg-secondary p-8 rounded-lg shadow-md w-full max-w-md">
        <h2 className="text-3xl font-bold mb-6 text-center text-secondary-foreground">Update Your Password</h2>
