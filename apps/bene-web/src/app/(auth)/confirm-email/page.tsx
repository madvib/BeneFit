    ...
    return (
      <div className="container mx-auto p-8 flex items-center justify-center min-h-screen">
        <div className="text-center">
          ...
          <p className="mt-4 text-secondary-foreground">Checking confirmation status...</p>
        </div>
      </div>
    );
  }
  ...
  return (
    <div className="container mx-auto p-8 flex items-center justify-center min-h-screen">
      <div className="bg-secondary p-8 rounded-lg shadow-md w-full max-w-md">
        <h2 className="text-3xl font-bold mb-6 text-center text-secondary-foreground">Confirm Your Email</h2>
        ...
        <div className="space-y-4">
          ...
          <div className="text-center mt-4 text-sm text-secondary-foreground">
            Already confirmed? <a href="/login" className="text-primary hover:underline">Log in</a>
          </div>
        </div>
      </div>
    </div>
