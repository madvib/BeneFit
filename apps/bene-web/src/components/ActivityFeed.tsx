              ...
              <div className="flex items-center gap-3">
                ...
                <div className="flex-1 min-w-0 w-full">
                  <div className="flex flex-col sm:flex-row sm:justify-between sm:items-start gap-1 w-full">
                    <h4 className="font-semibold text-sm sm:text-base break-words max-w-full">{activity.title}</h4>
                    <span className="text-xs sm:text-sm text-muted-foreground whitespace-nowrap self-start sm:self-auto">{formatTimeAgo(activity.timestamp)}</span>
                  </div>
