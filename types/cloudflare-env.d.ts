/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface CloudflareEnv ../../packages/utils/src/types/cloudflare-env.d.ts` (hash: 79851ef0fa29e78c1ce4e42c213fd887)
// Runtime types generated with workerd@1.20251011.0 2025-03-01 global_fetch_strictly_public,nodejs_compat
declare namespace Cloudflare {
  interface GlobalProps {
    mainModule: typeof import('../apps/web/.open-next/worker');
  }
  interface Env {
    NEXTJS_ENV: string;
