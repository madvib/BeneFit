...
export function createProgressionStrategy(props: ProgressionStrategyProps): Result<ProgressionStrategy> {
...
export function createLinearProgression(weeklyIncrease: number, deloadFrequency: number = 4): Result<ProgressionStrategy> {
...
export function createUndulatingProgression(weeklyIncrease: number): Result<ProgressionStrategy> {
...
export function createAdaptiveProgression(weeklyIncrease: number, minIncrease: number = 0.02, maxIncrease: number = 0.08): Result<ProgressionStrategy> {
  return createProgressionStrategy({
    type: 'adaptive',
    weeklyIncrease,
    minIncrease,
