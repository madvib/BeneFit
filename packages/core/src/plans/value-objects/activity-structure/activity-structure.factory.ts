...
export function createActivityStructure(props: ActivityStructureProps): Result<ActivityStructure> {
  // Validation
  if (props.intervals) {
...
export function createActivityStructureWithIntervals(intervals: Interval[], rounds?: number): Result<ActivityStructure> {
  return createActivityStructure({ intervals, rounds });
}

export function createActivityStructureWithExercises(exercises: Exercise[], rounds?: number): Result<ActivityStructure> {
