...
export const createCommunicationError = (message: string) => new CommunicationError(message);
...
export const createContextUpdateError = (message: string) => new ContextUpdateError(message);
export const createMessageProcessingError = (message: string) => new MessageProcessingError(message);
