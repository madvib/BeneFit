...
export type {
  ...
  GeneratePlanFromGoalsRequestClient,
...
export type {
  ...
  AdjustPlanBasedOnFeedbackRequestClient,
...
export type {
  ...
  GetUpcomingWorkoutsRequestClient,
...
export type {
  ...
  CreateUserProfileRequestClient,
...
export type {
  ...
  UpdateFitnessGoalsRequestClient,
...
export type {
  ...
  UpdatePreferencesRequestClient,
...
export type {
  ...
  AddWorkoutReactionRequestClient,
...
export type {
  ...
  GetWorkoutHistoryRequestClient,
...
export type {
  ...
  JoinMultiplayerWorkoutRequestClient,
