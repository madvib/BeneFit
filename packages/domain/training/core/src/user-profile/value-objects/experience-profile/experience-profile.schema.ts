...
type ExperienceProfileSchema = z.infer<typeof ExperienceProfileSchema>;

// DOMAIN to PRESENTATION (Schema)
export function toExperienceProfileSchema(profile: ExperienceProfile): ExperienceProfileSchema {
  return {
    level: profile.level,
    history: {
      ...profile.history,
...
export function fromExperienceProfileSchema(schema: ExperienceProfileSchema): ExperienceProfile {
  return {
    level: schema.level,
    history: {
      ...schema.history,
