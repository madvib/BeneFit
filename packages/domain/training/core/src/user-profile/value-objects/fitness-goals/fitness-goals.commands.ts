...
// Update functions
export function updatePrimaryGoal(
  goals: FitnessGoals,
...
export function addSecondaryGoal(
  goals: FitnessGoals,
...
export function removeSecondaryGoal(
  goals: FitnessGoals,
  secondaryGoal: string,
): FitnessGoals {
  return {
...
export function updateTargetWeight(
  goals: FitnessGoals,
...
export function updateTargetBodyFat(
  goals: FitnessGoals,
...
export function updateTargetDate(
  goals: FitnessGoals,
  targetDate: Date,
): Result<FitnessGoals> {
...
export function addTargetSuccessCriterion(
  goals: FitnessGoals,
  criterion: string,
): FitnessGoals {
...
export function removeTargetSuccessCriterion(
  goals: FitnessGoals,
  criterion: string,
): FitnessGoals {
  return {
...
export function getGoalUrgency(
  goals: FitnessGoals,
