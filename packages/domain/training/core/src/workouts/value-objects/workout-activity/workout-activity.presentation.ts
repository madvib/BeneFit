import { z } from 'zod';
import { ActivityStructureSchema, toActivityStructureSchema } from '../activity-structure/activity-structure.presentation.js';
...
export type WorkoutActivityPresentation = z.infer<typeof WorkoutActivitySchema>;

export function toWorkoutActivitySchema(activity: WorkoutActivity): WorkoutActivityPresentation {
  return {
    name: activity.name,
    type: activity.type,
