...
export type TemplateRulesPresentation = z.infer<typeof TemplateRulesSchema>;

export function toTemplateRulesSchema(rules: TemplateRules): TemplateRulesPresentation {
  return {
