...
import { CheckInPresentationSchema, toCheckInPresentation } from '../check-in.presentation.js';
...
describe('CheckIn Presentation', () => {
  it('should map a valid check-in to presentation DTO', () => {
    ...
    const presentation = toCheckInPresentation(checkIn);

    const result = CheckInPresentationSchema.safeParse(presentation);
