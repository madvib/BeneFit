...
import { CoachErrors } from '@bene/coach-domain';

/**
 * Anthropic implementation of the AICoachService interface
 * Uses the provider abstraction to support multiple AI models
 */
export class AnthropicAICoachService implements AICoachService {
