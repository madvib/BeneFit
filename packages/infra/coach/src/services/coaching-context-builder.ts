...
import { CoachErrors, TREND_MAPS } from '@bene/coach-domain';
 ...
 */
export class CoachContextBuilderImpl implements CoachContextBuilder {
  constructor(
  ...
  async buildContext(userId: string): Promise<Result<CoachContext>> {
    try {
      ...
      const context: CoachContext = {
        ...
        reportedInjuries: Array.from(userProfile.trainingConstraints?.injuries),
