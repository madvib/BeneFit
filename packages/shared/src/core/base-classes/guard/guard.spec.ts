...
describe('Guard', () => {
  ...
  describe('combine', () => {
    ...
    it('should return the first failure if one fails', () => {
      ...
      expect(combined.errorMessage).toBe('first error'); // Assuming Result.fail stores error string/obj
    });
  });
  ...
  describe('againstNullOrUndefined', () => {
    ...
    it('should fail for null', () => {
      ...
      expect(result.errorMessage).toContain('is null or undefined');
    });
  ...
  describe('againstNullOrUndefinedBulk', () => {
    ...
    it('should fail if any argument is null', () => {
      ...
      const result = Guard.againstNullOrUndefinedBulk(args);
      expect(result.isFailure).toBe(true);
      expect(result.errorMessage).toContain('arg2 is null or undefined');
    });
  });
  ...
  describe('againstTooLong', () => {
    ...
    it('should fail if string exceeds max length', () => {
      ...
      expect(result.isFailure).toBe(true);
      expect(result.errorMessage).toContain('longer than 5 characters');
    });
  });
  ...
  describe('isOneOf', () => {
    ...
    it('should fail if value is not in the valid list', () => {
      ...
      expect(result.isFailure).toBe(true);
      expect(result.errorMessage).toContain('isn\'t one Of the correct types');
    });
  });
  ...
  describe('isTrue', () => {
    ...
    it('should fail if value is false', () => {
      ...
      expect(result.isFailure).toBe(true);
      expect(result.errorMessage).toContain('is not true');
    });
  });
  ...
  describe('inRange', () => {
    ...
    it('should fail if number is below min', () => {
      ...
      expect(result.isFailure).toBe(true);
      expect(result.errorMessage).toContain('not within range');
    });
  ...
  describe('allInRange', () => {
    ...
    it('should fail if one number is out of range', () => {
      ...
      expect(result.isFailure).toBe(true);
      expect(result.errorMessage).toContain('is not within the range');
    });
  });
  ...
  describe('againstNegativeOrZero', () => {
    ...
    it('should fail for zero', () => {
      ...
      expect(result.isFailure).toBe(true);
      expect(result.errorMessage).toContain('is negative or zero');
    });
